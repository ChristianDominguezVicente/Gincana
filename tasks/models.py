...
class Profesor(AbstractBaseUser):
    ...
    genero = models.CharField("Género", max_length=1 ,choices=GENDER_CHOICES ,default='M', null=True)
    pais = models.CharField("País", max_length=2 ,choices=COUNTRY_CHOICES ,default='ES', null=True)
